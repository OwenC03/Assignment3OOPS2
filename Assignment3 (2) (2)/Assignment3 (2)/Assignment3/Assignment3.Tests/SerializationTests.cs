...
using System.IO; // Add this namespace for File.Exists
...
namespace Assignment3.Tests
{
    public class SerializationTests
    {
        ...
        public void Setup()
        {
            ...
            this.users.AddLast(new User(1, "Joe Blow", "jblow@gmail.com", "password"));
            this.users.AddLast(new User(2, "Joe Schmoe", "joe.schmoe@outlook.com", "abcdef"));
            this.users.AddLast(new User(3, "Colonel Sanders", "chickenlover1890@gmail.com", "kfc5555"));
            this.users.AddLast(new User(4, "Ronald McDonald", "burgers4life63@outlook.com", "mcdonalds999"));
        }
